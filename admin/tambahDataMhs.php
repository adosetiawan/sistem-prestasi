          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Form Add Data Mahasiswa</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
                ...
                <form action="insertDataMhs.php" method="POST">
                  ...
                  <div class="col-md-8">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Nama" name="nama" value="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Tanggal Lahir</label>
                      <input type="date" class="form-control" id="exampleInputPassword1" placeholder="" name="tgl_lahir" value="">
                    </div>
                    <div class="form-group">
                      ...
                      <?php
         		          ...
         		          ?>
                        <option value="<?=$data['prodi_kode']?>"><?=$data['prodi_nama']?></option>
					            <?php
        			        }
        			        ?>
                      </select>
