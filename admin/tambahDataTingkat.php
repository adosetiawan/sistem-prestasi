                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Form Add Data Tingkat</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="insertDataTingkat.php" method="POST">
                                    <div class="card-body row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Nama Tingkat</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1"
                                                    placeholder="Masukkan Nama tingkat" name="nama-tingkat" value="">
                                            </div>
