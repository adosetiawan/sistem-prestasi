                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="insertDataPrestasi.php" method="POST" enctype="multipart/form-data">
                                    <div class="card-body row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="nama-prestasi">Nama Prestasi</label>
                                                <input type="text" class="form-control" id="nama-prestasi" placeholder="Masukan nama prestasi" name="nama-prestasi" value="">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-7">
                                                        ...
                                                        <input type="text" class="form-control" id="jenis-lomba" placeholder="Masukkan Jenis Lomba" name="jenis-lomba" value="">
                                                    </div>
                                                    <div class="col-5">
                                                        <label for="tgl-lomba">Tanggal Lomba</label>
                                                        <input type="date" class="form-control" id="tgl-lomba" placeholder="" name="tgl-lomba" value="">
                                                    </div>
                                                </div>
                                            </div>
                                                     ...
                                                     if($cart->total_items()>0){
                                                        foreach($cart->contents() as $filename){
                                                            $gambar[] = array(
                                                                ...
                                                                'size'=>$filename['price'],
                                                                'id'=> $filename['id'],
                                                                'url'=>'../assets/upload/img/'.$filename['name'],
                                                            );
                                                        }
                                                     }
                                                ?>
                                                <div action="ajax/insertDataPrestasiDZ.php" file-added='<?=json_encode($gambar)?>' method="POST" class="dropzone"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
